...
import kr.easw.estrader.android.databinding.FragmentNewItemListBinding
...
class NewItemListFragment : BaseFragment<FragmentNewItemListBinding>(FragmentNewItemListBinding::inflate) {
    ...
    private fun initRecycler() {
        pagingAdapter = ViewUtil.setupNewItemListAdapter(this, dataList)
