...
import kr.easw.estrader.android.databinding.FragmentPaymentBinding
...
class PaymentFragment : Fragment(){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.next.setOnClickListener {
            ...
            // 서버에 formattedNumber 보내는거도 들어가야댐
            requireActivity().supportFragmentManager.replaceFragment<ProxyselectFragment>(
                R.id.container_view,
                null
            )
        }
